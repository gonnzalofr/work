...
class ExperimentServerApp:
    ...
    def __init__(self, args: argparse.Namespace) -> None:
        ...
        self.root = tk.Tk()
        self.root.title("VENUS Experiment Challenge Server")
    ...
    def _refresh_labels(self) -> None:
        ...
        self.color_var.set(f"Colors: {len(self.colors)} squares")
    ...
    def _draw_color_detection(self, detection: ColorDetection) -> None:
        ...
        self.canvas.create_text(
            x_px,
            y_px + size + 10,
            text=f"{detection.color} {detection.red}/{detection.green}/{detection.blue}",
            fill="#333333",
            font=("TkDefaultFont", 9),
        )
